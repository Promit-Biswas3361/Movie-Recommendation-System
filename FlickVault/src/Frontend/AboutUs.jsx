...
const AboutUs = () => {
  return (
    <div className="">
      <Navbar />
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-[#03333d] bg-fixed text-white items-center flex flex-col px-6 py-12 mb-[-100px] lg:mb-[-140px]">
        <div className="flex flex-col md:flex-row items-center md:items-start px-3 py-0 mt-15 md:mt-20">
